...
#define LOCALE_FORMAT "%A, der %d. %B %Y"
#define LOCALIZED 9
...
#endif
#ifdef PDF
"If 'PS' is defined 'PDF' must not be as well"
#endif
#endif /* PS */

#ifdef PDF
#ifndef GRAPH
"If 'PDF' is defined 'GRAPH' must be too"
#endif
#ifdef PS
"If 'PDF' is defined 'PS' must not be as well"
#endif
#endif /* PDF */
...
#define cSign      12
#define MaxNumberedAsteroid 320000
...
/* Munich Rhythms */
#ifdef MR /*K.R.*/
#define nRightDirection -1
#define nLeftDirection   1
#define nDefaultRhythm   7
#endif
...
#ifdef MR /* K.R.*/
#define FValidRhythm(r) FBetween(r, -343, 343)
#define FValidDirection(r) FBetween(r, -1, 1)
#endif
...
#define SwapN(n1, n2)  n1 ^= n2; n2 ^= n1; n1 ^= n2;
...
#ifdef MR /*K.R.*/
#define HourFromTime(r) (int) (RSgn(r)*RFloor(r))
#define MinFromTime(r) (int) (RFract(r) * 60.0)
#define SecFromTime(r) (int) (RFract(RFract(r) * 60.0) * 60.0 + rRound / 60.0)
#endif
/*
******************************************************************************
** Type Definitions.
...
#ifdef MR /*K.R.*/
  _bool fMunichRhythm;    /* -YM  Munich Rhythm Theory (Münchner Rhythmenlehre) */
#endif
...
#ifdef PDF
  _bool fPDF;        /* Are we generating a PostScript file (-Xp set).   */
#endif
...
#endif
#ifdef PDF               /* Variables used by the PDF generator. */
  HPDF_Doc  hpdfDoc;    /**/
  HPDF_Font hpdfTextFont;   /**/
  HPDF_Font hpdfGlyphFont;   /**/
  HPDF_Page hpdfPage;   /**/
  HPDF_REAL rPageHeight;/**/
  HPDF_REAL rPageWidth; /**/
  char *szLocale;
  char *szLocaleFormat;
#endif
