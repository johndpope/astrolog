...
#ifdef MR /*K.R.*/
extern void PrintAllRhythms(void);
extern void ComputeHouseSize(void);
extern void ComputeInHouses(void);
extern void PrintRhythm(int, int, real, int);
...
extern void PrintGrand P((int, int, int, int, int));
...
extern void PrintAspect P((int, int, int, int, int, int, int, int));
extern void PrintAspect3D P((int, int, int, double, int, int, int, int, int));
...
#ifdef PDF
extern int PdfBegin P((void));
extern void PdfWriteHeader P((void));
extern void PdfEnd P((void));
#endif
